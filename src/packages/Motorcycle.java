...
public class Motorcycle extends VehicleType implements Vehicle {
    ...
    public static void loadMotorcycles(ArrayList<Motorcycle> motorcycles) {
        try (BufferedReader reader = new BufferedReader(new FileReader("motorcycles.dat"))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (parts.length == 7) {
                    motorcycles.add(new Motorcycle(parts[0], parts[1], parts[2], parts[3], Double.parseDouble(parts[4]),
                            parts[5], parts[6]));
                }
            }
        } catch (IOException e) {
    ...
    public static void searchMotorcycle(ArrayList<Motorcycle> motorcycles, String model)
    ...
    public static void updateMotorcycleInfo(ArrayList<Motorcycle> motorcycles, String vin)
            throws MotorcycleNotFoundException {
        for (Motorcycle motorcycle : motorcycles) {
